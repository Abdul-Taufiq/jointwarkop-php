...
//query
$sedia = query("SELECT * FROM sedia WHERE id_sedia = $id")[0];
...
<html>
<head>
	<title>Ubah Data makanan atau Minuman</title>
...
<body>
  ...
  <div class="konten" align="center">
	<h1>UBAH DATA MAKANAN ATAU MINUMAN</h1>
	<form action="" method="post" enctype="multipart/form-data">
	<input type="hidden" name="id" value=" <?= $sedia["id_sedia"] ?> ">
	<table border="0" cellpadding="10" cellspacing="5" style="background-color: white; width: 40%; padding: 10px;">
		<tr>
			...
			<li style="margin: 10px 0;">
				...
				<input type="text" name="nama" id="nama" required autocomplete="off" style="margin: 10px; width: 70%; " value=" <?= $sedia["nama"] ?> ">
			</li>
			<li style="margin: 10px 0;">
				<label for="kategori"> Kategori : </label><br>
				 <select name="kategori" id="kategori" style="width: 70%; margin: 10px;" value=">
				 	 <?= $sedia["kategori"] ?> "
			...
			<li style="margin: 10px 0;">
				...
				<input type="number" name="harga" id="harga" required autocomplete="off" value= <?= $sedia["harga"] ?>  style="margin: 10px; width: 70%;" >
			</li>
			<li style="margin-top: 0;">
				<label for="dskp"> Deskripsi : </label><br>
				<textarea name="dskp" id="dskp" rows="3" cols="47"   style="margin: 10px;"><?= $sedia["dskp"] ?></textarea>
			</li>
			<li style="margin: 10px 0;">
				<label for="gambar"> Gambar : </label><br>
				<input type="file" name="gambar" id="gambar" autocomplete="off" value="<?=$sedia["gambar"]?> " style="margin: 10px; width: 70%;">
			</li>
