...
<html>
<head>
	<title>Tambah Data Web Development</title>
...
<body>
  ...
  <div class="konten" align="center">
	<h1>TAMBAH DATA WEB DEVELOPMENT</h1>
	...
	<table border="0" cellpadding="10" cellspacing="5" style="background-color: white; width: 40%; padding: 10px;">
		<tr>
			...
			<li style="margin: 10px 0;">
				...
				<input type="text" name="nim" id="nim" required autocomplete="off" style="margin: 10px; width: 70%; ">
			</li>
			<li style="margin: 10px 0;">
