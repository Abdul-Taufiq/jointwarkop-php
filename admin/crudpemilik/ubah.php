...
<body>
  ...
  <div class="konten" align="center">
	...
	<input type="hidden" name="id" value=" <?= $pemilik["id_pemilik"] ?> ">
	<table border="0" cellpadding="10" cellspacing="5" style="background-color: white; width: 40%; padding: 10px;">
		<tr>
			...
			<li style="margin: 10px 0;">
				...
				<input type="text" name="nama" id="nama" required autocomplete="off" style="margin: 10px; width: 70%; " value=" <?= $pemilik["nama"] ?> ">
			</li>
			<li style="margin: 10px 0;">
				<label for="ttl"> TTL : </label> <br>
				<input type="text" name="ttl" id="ttl" required autocomplete="off" style="margin: 10px; width: 70%; " value=" <?= $pemilik["ttl"] ?> ">
			</li>
			<li style="margin-top: 0;">
				<label for="alamat"> Alamat : </label><br>
				<textarea name="alamat" id="alamat" rows="3" cols="47" style="margin: 10px;"><?=$pemilik["alamat"]?> </textarea>
			</li>
			<li style="margin: 10px 0;">
			...
			<li style="margin: 10px 0;">
				...
				<input type="text" name="nohp" id="nohp" s autocomplete="off" style="margin: 10px; width: 70%;" value="<?=$pemilik["nohp"]?>">
			</li>
			<li style="margin: 10px 0;">
				<label for="gambar"> Gambar : </label><br>
				<input type="file" name="gambar" id="gambar" s autocomplete="off" style="margin: 10px; width: 70%;"  value="<?=$pemilik["gambar"]?>">
			</li>
